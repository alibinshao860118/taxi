...
public class TestController {
    ...
    public ResponseResult error(@RequestParam(required = false) String code){
        ...
        return ResponseResult.error("异常请求，请重新输入");
    }


    @GetMapping("/test/login/v2")
    public void loginV2(@RequestParam(required = false) String code, @RequestParam(required = false) String state,
